sap.ui.define([
	...
	"use strict";
	return Controller.extend("sap.mlf.bar8.controller.ImageClassification", {
		onInit: function () {
		...
		handleTypeMissmatch: function(oEvent) {
			...
			MessageToast.show("O tipo do arquivo *." + oEvent.getParameter("fileType") + " não é suportado. Escolha um dos seguintes tipos: " + supportedFileTypes);
		},
